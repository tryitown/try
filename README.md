...
SEOTitle: 的博客 | BY Blog		# SEO 标题
description: "Hey"	   	   # 随便说点，描述一下

# SNS settings      
github_username: jiale15     # 你的github账号
...
我的博客标题是 **“BY Blog”** 但是我想要在搜索的时候显示 **“的博客 | BY Blog”** ，这个就需要 SEO Title 来定义了。
